...
# higher order thin-plate spline collocation (unsymmetric) on the sphere and 
...
preconMtrx, numNeighb = locLagPreconColl(ptSet, kdTree, locRadius, buildSpecialUnsCollMtrx, lapBelTps, pdeParam, 9)
