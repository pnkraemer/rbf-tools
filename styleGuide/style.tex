...
Plots are a-priori quite ugly. Every plot needs to have:
\begin{itemize}
\item Axes labels
\item Title
\item Grid
\end{itemize}
On top of that, for aesthetic purposes, we follow:
\begin{enumerate}
\item Change font size to 18 by adding
\begin{Verbatim}[formatcom=\color{blue!50!black}]
...
\item Main color is \texttt{darkslategray} which is a decent tradeoff between color and simplicity
