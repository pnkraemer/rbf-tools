...
\end{Verbatim}
 Do not change them in the script--it turned out to be quite confusing
\end{enumerate}
...
\item \textbf{Legend:} Put details in the legend, like number of points or underlying regularity
\end{itemize}
